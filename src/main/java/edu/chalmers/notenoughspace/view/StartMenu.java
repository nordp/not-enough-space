...
public class StartMenu extends AbstractAppState {
    ...
    */
    ...
    public void simpleInitMenu() {
        ...
        nifty.addScreen("start", new ScreenBuilder("start") {
            {
                controller(new DefaultScreenController());            //new edu.chalmers.notenoughspace.ctrl.StartScreenController()
